...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-800 flex flex-col items-center justify-center py-12 px-6">
        <div class="bg-gray-600 rounded-lg shadow-lg p-8 max-w-lg w-full">
            <h1 class="text-3xl font-semibold text-gray-200 mb-4">Login</h1>
            <?php 
            ...
            <form action="acoes.php" method="POST" class="space-y-4">
                ...
                <div class="space-y-4">
                <button type="submit" name="logar_usuario" class="mt-6 block text-center bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 transition w-full">Entrar</button>
            </div>
            </form>
        </div>
    </div>
